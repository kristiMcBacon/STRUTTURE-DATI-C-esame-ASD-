...
#include "Lista_Ordinata\Order_list.h"

template <class tipoelem>
class Insieme {
public:
    typedef typename Order_list<tipoelem>::position posizione;
...
Insieme<tipoelem>::Insieme(const Insieme<tipoelem>& i) {
    setlist=Order_list<tipoelem>(i.setlist);
}
